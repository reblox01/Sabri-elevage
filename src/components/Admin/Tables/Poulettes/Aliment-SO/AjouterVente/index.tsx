  ...
  return (
    <main className="flex flex-1 flex-col p-4 md:p-20 mt-20">
      ...
      <div className='flex flex-wrap items-center gap-2 mb-10 mt-4'>
        ...
        <Button variant="clicked" className="flex items-center" onClick={() => router.push('/admin/tables/poulettes/aliment-so')}>
          Aliment Sofalim
        </Button>
      </div>
      ...
      <iframe className="airtable-embed" src="https://airtable.com/embed/appJvZpbixGGfkieH/pagb1HIeHtCwOX4L2/form" frameBorder="0" width="100%" height="1533"></iframe>
    </main>
  );
}
