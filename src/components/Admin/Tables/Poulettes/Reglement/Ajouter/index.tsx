  ...
  return (
    <main className="flex flex-1 flex-col p-4 md:p-20 mt-20">
      ...
      <div className='flex flex-wrap items-center gap-2 mt-4'>
        ...
        <Button variant="selected" className="flex items-center" onClick={() => router.push('/admin/tables/poulettes/reglement/ajouter')}>
          Ajouter
        </Button>
      </div>
      <iframe className="airtable-embed" src="https://airtable.com/embed/appJvZpbixGGfkieH/pagDWKdAZR56gtLcT/form" frameBorder="0" width="100%" height="900"></iframe>
    </main>
  );
}
